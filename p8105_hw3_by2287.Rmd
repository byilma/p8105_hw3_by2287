...
The dataset `accel_tidy` is a tidy version of the `accel` dataset, imported in the above code chunk. 
...
It contains informaiton collected from `r ny_noaa %>% pull(id) %>% n_distinct()` unique weather stations. 

Tidy-ing the ny_noaa dataset
```{r}
ny_noaa_tidy %>% 
